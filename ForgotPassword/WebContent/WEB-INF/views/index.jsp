    ...
    <div class="full-page">
        ...
        <div id='login-form' class='login-page'>
		    ...
		    <input type='password'class='input-field'placeholder='Enter Password' required>
		      <div class="forgot-password"> <a href="WEB-INF/views/forgot.jsp">Forgot Password?</a></div>
		    <button type='submit'class='submit-btn' onclick="openPopup()">Log in</button>
		 </form>
		 <form id='register' class='input-group-register'>
                    <input type='text'class='input-field'placeholder='Email Id' required >
		    <input type='password'class='input-field'placeholder='Enter Password' required>
		    <div class="forgot-password a"> <a href="WEB-INF/views/forgot.jsp">Forgot Password?</a></div>
		    <button type='submit'class='submit-btn' onclick="openPopup()">Log in</button>
	         </form>
            </div>
        </div>
